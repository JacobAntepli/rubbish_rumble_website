...
import "./BlogPost/BlogPostPage.css"
import BlogPostComponentImage from "./BlogPost/BlogPostComponentImage";
        ...
        <div className={"page"}>
            <Stack  direction={"column"}>
                <BlogPostComponent name={"Jacob"}
                                   ...
                                   />
                <BlogPostComponentImage name={"Chloe"}
                ...
                <BlogPostComponentImage name={"Irene"}
                                   progress={""}
                                   images={[
                                       "./assets/Images/Week1/rene1.png",
                                       "./assets/Images/Week1/rene2.png",
                                       "./assets/Images/Week1/rene3.png"
                                   ]}/>
                <BlogPostComponentImage name={"Sarah"}
